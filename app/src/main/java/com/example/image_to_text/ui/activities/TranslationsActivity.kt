...
class TranslationsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Utils.logAnalytic("TranslationActivity")
...
//        translateBtn = findViewById(R.id.translateBtn)
        ...
        back.setOnClickListener {
            Utils.logAnalytic("TranslationActivity close button clicked")
            finish()
        }
        ...
        copy.setOnClickListener {
            Utils.logAnalytic("TranslationActivity copy button clicked")
            yourString = sourceLanguage.text.toString()
            yourString?.let { it1 -> copyTextToClipboard(it1) }
        }
        share.setOnClickListener {
            Utils.logAnalytic("TranslationActivity share button clicked")
            yourString = sourceLanguage.text.toString()
        ...
        copy1.setOnClickListener {
            Utils.logAnalytic("TranslationActivity copy second button clicked")
            yourString1 = destinationLanguageTv.text.toString()
            yourString1?.let { it1 -> copyTextToClipboard(it1) }
        }
        share1.setOnClickListener {
            Utils.logAnalytic("TranslationActivity share second button clicked")
            yourString1 = destinationLanguageTv.text.toString()
            yourString1?.let { it1 -> shareImageAndText(it1) }
        }
        sourceLanguageChooseBtn.setOnClickListener {
            Utils.logAnalytic("TranslationActivity sourcelanguage button clicked")
            sourceLanguageCode()
        }

        destinationLanguageChooseBtn.setOnClickListener {
            Utils.logAnalytic("TranslationActivity destinationlanguage button clicked")
        ...
        eraseImageView.setOnClickListener(){
            Utils.logAnalytic("TranslationActivity erase data button clicked")
            sourceLanguage.text.clear()
        }

        micImageView.setOnLongClickListener {
            Utils.logAnalytic("TranslationActivity mic button clicked")
...
// Set click listener for the ImageView
        speaker.setOnClickListener {
            Utils.logAnalytic("TranslationActivity speaker button clicked")
