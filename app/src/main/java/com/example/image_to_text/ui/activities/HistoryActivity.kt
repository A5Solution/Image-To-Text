...
import com.example.image_to_text.ui.adapter.ImageTextAdapter
...
class HistoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Utils.logAnalytic("History Activity")
        ...
        back.setOnClickListener {
            Utils.logAnalytic("History Activity close button clicked")
            finish()
        }
        premium.setOnClickListener(){
            Utils.logAnalytic("History Activity premium button clicked")
