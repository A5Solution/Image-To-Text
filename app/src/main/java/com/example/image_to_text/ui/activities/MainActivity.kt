    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appUpdateInfoTask.addOnSuccessListener { appUpdateInfo ->
            ...
            if (appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE) {
                // Check if the update is flexible or immediate
                val updateType = when {
                ...
                // Prompt the user to update the app based on the available update type
                updateType?.let { type ->
                    appUpdateManager.startUpdateFlowForResult(
                        appUpdateInfo,
                        type,
                        this,
                        Companion.REQUEST_CODE_APP_UPDATE
                    )
                }
            }
        }
        ...
        history.setOnClickListener {
            Utils.logAnalytic("MainActivity Activity history button clicked")
            val isLifetimeSubscriptionActive = subscriptionManager.isLifetimeSubscriptionActive()
        ...
        binding.premium.setOnClickListener(){
            Utils.logAnalytic("MainActivity Activity premium button clicked")
        ...
        menu.setOnClickListener {
            Utils.logAnalytic("MainActivity Activity menu button clicked")
...
*/
        ...
        */
        ...
        imageViewCamera.setOnClickListener {
            Utils.logAnalytic("MainActivity Activity camera button clicked")
            binding.progressBar.visibility=View.VISIBLE
            count=1
            ad(count)
        }
        imageViewGallery.setOnClickListener {
            Utils.logAnalytic("MainActivity Activity text translation button clicked")
            binding.progressBar.visibility=View.VISIBLE
            count = 2
            ad(count)
        }
        binding.imageTranslation.setOnClickListener(){
            Utils.logAnalytic("MainActivity Activity voice translation button clicked")
            binding.progressBar.visibility=View.VISIBLE
            count=3
            ad(count)
        }
